...
<body>
	...
	<div class="sidebar-wrapper" data-simplebar="true">
		<div class="sidebar-header">
			...
			<div>
				<h4 class="logo-text">Medical Management</h4>
			</div>
		...
		<ul class="metismenu" id="menu">
			<li><a href="javascript:;" class="has-arrow">
				...
				<ul>
					<li><a href="addProduct"><i class='bx bx-radio-circle'></i>AddProduct</a>
					</li>
					<li><a href="getAllMedicines"><i class='bx bx-radio-circle'></i>ViewAllProduct</a>
					</li>
					<li><a href="index3.html"><i class='bx bx-radio-circle'></i>DeleteProduct</a>
					</li>
				</ul></li>
			...
			<li><a href="javascript:;" class="has-arrow">
					...
					<div class="menu-title">Category & Brand</div>
			</a>
				<ul>
					<li><a href="/getAllCategory">
					<i class='bx bx-radio-circle'></i>Add-Category</a></li>
					<li><a href="/getAllBrand"><i
							class='bx bx-radio-circle'></i> Add-Brand</a></li>
					<li><a href="app-file-manager.html"></a>
				</li>
				...
				<li><a href="javascript:;" class="has-arrow">
					...
					<div class="menu-title">Supplier Management</div>
			</a>
				<ul>
					<li><a href="/addSupplier"><i
							class='bx bx-radio-circle'></i>Add-Supplier</a></li>
					<li><a href=""><i
							class='bx bx-radio-circle'></i> Add-Brand</a></li>
					<li><a href="app-file-manager.html"></a>
					</li>
